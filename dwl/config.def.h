...
static const char *lockscrencmd[] = { "hyprlock", NULL };
...
/* commands (add to your config.h near termcmd/menucmd etc) */
static const char *vol_up[]    = { "/usr/bin/wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", "0.1+", NULL };
static const char *vol_down[]  = { "/usr/bin/wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", "0.1-", NULL };
static const char *vol_mute[]  = { "/usr/bin/wpctl", "set-mute", "@DEFAULT_AUDIO_SINK@", "toggle", NULL };
static const char *mic_mute[]  = { "/usr/bin/wpctl", "set-mute", "@DEFAULT_AUDIO_SOURCE@", "toggle", NULL };
static const char *bright_up[]   = { "/usr/bin/brightnessctl", "--class=backlight", "set", "+5%", NULL };
static const char *bright_down[] = { "/usr/bin/brightnessctl", "--class=backlight", "set", "5%-", NULL };
...
static const Key keys[] = {
    ...
    { MODKEY|WLR_MODIFIER_ALT,   XKB_KEY_b,          spawn,          {.v = waybarcmd} },

    { MODKEY,                    XKB_KEY_s,          spawn,          SHCMD("tmux-sessionizer-gui") },
    { MODKEY,                    XKB_KEY_b,          spawn,          SHCMD("bookmarks") },
    ...
    { MODKEY,                    XKB_KEY_Right,      spawn,          SHCMD("playerctl next") },
    { MODKEY,                    XKB_KEY_Left,       spawn,          SHCMD("playerctl previous") },
    { MODKEY,                    XKB_KEY_Up,         spawn,          SHCMD("playerctl -p spotify loop track") },
    { MODKEY,                    XKB_KEY_Down,       spawn,          SHCMD("playerctl -p spotify loop none") },
    { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Up,         spawn,          SHCMD("playerctl -p spotify shuffle on") },
    { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Down,       spawn,          SHCMD("playerctl -p spotify shuffle off") },
    { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_space,      spawn,          SHCMD("playerctl -p spotify play-pause") },
    ...
    // { MODKEY,                    XKB_KEY_0,          setlayout,      {.v = &layouts[2]} },
    ...
    { MODKEY|WLR_MODIFIER_CTRL, XKB_KEY_Down,                  spawn, SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 0.05-") },
    { MODKEY|WLR_MODIFIER_CTRL, XKB_KEY_Up,                    spawn, SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 0.05+") },

    { MODKEY|WLR_MODIFIER_ALT,  XKB_KEY_Down,                  spawn, SHCMD("brightnessctl --class=backlight set 5%-") },
    { MODKEY|WLR_MODIFIER_ALT,  XKB_KEY_Up,                    spawn, SHCMD("brightnessctl --class=backlight set +5%") },
